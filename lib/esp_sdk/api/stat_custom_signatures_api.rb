  ...
  class StatCustomSignaturesApi
    ...
    def list_for_stat_with_http_info(stat_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: StatCustomSignaturesApi.list_for_stat ..."
      end
      # verify the required parameter 'stat_id' is set
      fail ArgumentError, "Missing the required parameter 'stat_id' when calling StatCustomSignaturesApi.list_for_stat" if stat_id.nil?
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: StatCustomSignaturesApi#list_for_stat\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def show_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: StatCustomSignaturesApi.show ..."
      end
      # verify the required parameter 'id' is set
      fail ArgumentError, "Missing the required parameter 'id' when calling StatCustomSignaturesApi.show" if id.nil?
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: StatCustomSignaturesApi#show\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
