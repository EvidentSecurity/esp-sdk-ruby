...
module ESP
  class IntegrationsServiceNowApi
    ...
    def create(external_account_ids, incident_type, instance_url, name, password, username, opts = {})
      data, _status_code, _headers = create_with_http_info(external_account_ids, incident_type, instance_url, name, password, username, opts)
      return data
    end
    ...
    def create_with_http_info(external_account_ids, incident_type, instance_url, name, password, username, opts = {})
