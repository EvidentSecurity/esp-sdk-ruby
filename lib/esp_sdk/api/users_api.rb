...
module ESP
  class UsersApi
    ...
    # @return [User]
    def create(email, first_name, last_name, opts = {})
      data, _status_code, _headers = create_with_http_info(email, first_name, last_name, opts)
      return data
    end
    ...
    def create_with_http_info(email, first_name, last_name, opts = {})
