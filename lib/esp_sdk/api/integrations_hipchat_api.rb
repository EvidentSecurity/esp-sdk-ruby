...
module ESP
  class IntegrationsHipchatApi
    ...
    def create(token, room, name, external_account_ids, opts = {})
      data, _status_code, _headers = create_with_http_info(token, room, name, external_account_ids, opts)
      return data
    end
    ...
    def create_with_http_info(token, room, name, external_account_ids, opts = {})
