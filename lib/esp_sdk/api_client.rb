...
module ESP
  class ApiClient
    ...
    # @return [Boolean] True if the MIME is application/vnd.api+json
    def json_mime?(mime)
       (mime == "*/*") || !(mime =~ /\Aapplication\/vnd.api\+json(;.*)?\z/i).nil?
    end
    ...
    def deserialize(response, return_type)
      ...
      content_type = response.headers['Content-Type'] || 'application/vnd.api+json'
    ...
    def convert_to_type(data, return_type)
      ...
      when /\AHash\<String, (.+)\>\z/
        ...
        data = data[:data] unless return_type == 'PaginatedCollection'
    ...
    # @return [String] the Accept header (e.g. application/vnd.api+json)
    ...
    # @return [String] the Content-Type header  (e.g. application/vnd.api+json)
    def select_header_content_type(content_types)
      # use application/vnd.api+json by default
      return 'application/vnd.api+json' if content_types.nil? || content_types.empty?
