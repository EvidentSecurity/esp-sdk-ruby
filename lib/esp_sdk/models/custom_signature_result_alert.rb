...
module ESP
  ...
  class CustomSignatureResultAlert < BaseObject
    ...
    def hash
      [id, created_at, status, resource, metadata, tags, updated_at, external_account, external_account_id, region, region_id, custom_signature, custom_signature_id].hash
    end
