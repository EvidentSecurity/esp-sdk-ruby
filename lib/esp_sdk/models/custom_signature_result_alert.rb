...
module ESP
  ...
  class CustomSignatureResultAlert < BaseObject
    ...
    def hash
      [id, code, created_at, error_messages, language, status, updated_at, external_account, external_account_id, region, region_id, custom_signature, custom_signature_id, errors].hash
    end
