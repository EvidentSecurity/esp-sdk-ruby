...
module ESP
  ...
  class ComplianceDomain < BaseObject
    ...
    def hash
      [id, created_at, name, identifier, updated_at, position, compliance_standard, compliance_standard_id, compliance_controls, compliance_control_ids, errors].hash
    end
