...
module ESP
  # A(n) Signature Custom Risk Level object
  class SignatureCustomRiskLevel < BaseObject
    ...
    def hash
      [relationships, errors, id, created_at, risk_level, updated_at, external_account, external_account_id, signature, signature_id].hash
    end
