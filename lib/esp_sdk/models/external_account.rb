...
module ESP
  ...
  class ExternalAccount < BaseObject
    ...
    def hash
      [id, account, arn, created_at, external_id, name, updated_at, cloudtrail_name, organization, organization_id, sub_organization, sub_organization_id, team, team_id, scan_intervals, scan_interval_ids, disabled_signatures, disabled_signature_ids, credentials, credentials_id, errors].hash
    end
