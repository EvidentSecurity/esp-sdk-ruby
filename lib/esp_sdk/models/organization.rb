...
module ESP
  ...
  class Organization < BaseObject
    ...
    def hash
      [relationships, errors, id, name, created_at, updated_at, custom_signatures, custom_signature_ids, external_accounts, external_account_ids, sub_organizations, sub_organization_ids, teams, team_ids, users, user_ids].hash
    end
