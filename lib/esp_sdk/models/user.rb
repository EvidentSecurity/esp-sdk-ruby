...
module ESP
  ...
  class User < BaseObject
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'mfa_enabled')
        self.mfa_enabled = attributes[:'mfa_enabled']
      end

      if attributes.has_key?(:'disable_daily_emails')
        self.disable_daily_emails = attributes[:'disable_daily_emails']
      end
      ...
      if attributes.has_key?(:'locked_at')
    ...
    def hash
      [relationships, errors, id, created_at, email, time_zone, first_name, last_name, phone, mfa_enabled, disable_daily_emails, locked, locked_at, updated_at, organization, organization_id, sub_organizations, sub_organization_ids, teams, team_ids, role, role_id].hash
    end
