...
module ESP
  ...
  class Attribution < BaseObject
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'raw_event')
        self.raw_event = attributes[:'raw_event']
      end
      ...
      if attributes.has_key?(:'scope_name')
    ...
    def hash
      [id, event_id, event_name, event_time, raw_event, user, ip_address, scope_name, alert, alert_id].hash
    end
