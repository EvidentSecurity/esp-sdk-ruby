...
module ESP
  ...
  class Report < BaseObject
    ...
    def hash
      [relationships, errors, id, created_at, status, updated_at, alerts, alert_ids, organization, organization_id, sub_organization, sub_organization_id, team, team_id, external_account, external_account_id, stat].hash
    end
