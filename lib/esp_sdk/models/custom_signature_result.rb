...
module ESP
  # A(n) Custom Signature/Result object
  class CustomSignatureResult < BaseObject
    ...
    def self.swagger_types
      {
        ...
        :'alerts' => :'Array<CustomSignatureResultAlert>',
    ...
    def hash
      [id, code, created_at, error_messages, language, status, updated_at, external_account, external_account_id, region, region_id, definition, definition_id, alerts, alert_ids, errors].hash
    end
