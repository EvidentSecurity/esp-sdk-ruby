...
module ESP
  ...
  class Team < BaseObject
    ...
    def hash
      [relationships, errors, id, name, created_at, updated_at, custom_signatures, custom_signature_ids, external_accounts, external_account_ids, organization, organization_id, sub_organization, sub_organization_id].hash
    end
