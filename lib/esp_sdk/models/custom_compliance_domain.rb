...
module ESP
  ...
  class CustomComplianceDomain < BaseObject
    ...
    def hash
      [id, identifier, name, created_at, updated_at, position, custom_compliance_standard, custom_compliance_standard_id, custom_compliance_controls, custom_compliance_control_ids].hash
    end
