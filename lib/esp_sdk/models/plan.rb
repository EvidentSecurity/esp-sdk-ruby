...
module ESP
  ...
  class Plan < BaseObject
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'grandfathered')
        self.grandfathered = attributes[:'grandfathered']
      end
    ...
    def hash
      [id, name, amount, max_external_accounts, max_users, max_custom_signatures, plan_type, grandfathered].hash
    end
