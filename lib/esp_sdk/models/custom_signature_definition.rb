...
module ESP
  # A(n) Custom Signature/Definition object
  class CustomSignatureDefinition < BaseObject
    ...
    def hash
      [id, code, created_at, language, version_number, status, updated_at, custom_signature, custom_signature_id, results, result_ids, errors].hash
    end
