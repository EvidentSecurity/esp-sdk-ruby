...
module ESP
  ...
  class CustomSignature < BaseObject
    ...
    def hash
      [id, created_at, description, identifier, name, resolution, risk_level, updated_at, organization, organization_id, teams, team_ids, definitions, definition_ids, errors].hash
    end
