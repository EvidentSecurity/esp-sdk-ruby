...
module ESP
  ...
  class CustomComplianceStandard < BaseObject
    ...
    attr_accessor :max_controls

    # Associated Custom Compliance Domains
    attr_accessor :custom_compliance_domains

    # Associated Custom Compliance Domains IDs
    attr_accessor :custom_compliance_domain_ids
    ...
    def self.swagger_types
      {
        ...
        :'custom_compliance_domains' => :'Array<CustomComplianceDomain>',
        :'custom_compliance_domain_ids' => :'Array<Integer>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'max_domains')
        self.max_domains = attributes[:'max_domains']
      end

      if attributes.has_key?(:'max_controls')
        self.max_controls = attributes[:'max_controls']
      end

      if attributes.has_key?(:'custom_compliance_domains')
        if (value = attributes[:'custom_compliance_domains']).is_a?(Array)
          self.custom_compliance_domains = value
        end
      end

      if attributes.has_key?(:'custom_compliance_domain_ids')
        if (value = attributes[:'custom_compliance_domain_ids']).is_a?(Array)
          self.custom_compliance_domain_ids = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          max_controls == o.max_controls &&
          custom_compliance_domains == o.custom_compliance_domains &&
          custom_compliance_domain_ids == o.custom_compliance_domain_ids &&
    ...
    def hash
      [id, organization_id, name, created_at, description, updated_at, max_accounts, max_domains, max_controls, custom_compliance_domains, custom_compliance_domain_ids, custom_compliance_controls, custom_compliance_control_ids].hash
    end
