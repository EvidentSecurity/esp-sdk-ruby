...
# Unit tests for ESP::RegionStatsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RegionStatsApi' do
  before do
    # run before each test
    @instance = ESP::RegionStatsApi.new
  end
  ...
  describe 'test an instance of RegionStatsApi' do
    it 'should create an instact of RegionStatsApi' do
      expect(@instance).to be_instance_of(ESP::RegionStatsApi)
    end
  end
