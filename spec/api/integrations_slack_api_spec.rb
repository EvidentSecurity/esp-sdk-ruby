...
# Unit tests for ESP::IntegrationsSlackApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'IntegrationsSlackApi' do
  before do
    # run before each test
    @instance = ESP::IntegrationsSlackApi.new
  end
  ...
  describe 'test an instance of IntegrationsSlackApi' do
    it 'should create an instact of IntegrationsSlackApi' do
      expect(@instance).to be_instance_of(ESP::IntegrationsSlackApi)
    end
  end
